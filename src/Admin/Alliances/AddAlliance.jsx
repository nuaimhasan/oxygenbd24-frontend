...
export default function AddAlliance({ addModal, setAddModal }) {
  const [loading, setLoading] = useState(false);
  const [images, setImages] = useState([]);

  const handleAddTAlliance = (e) => {
    e.preventDefault();
  ...
  return (
    <>
      ...
      <div className={`modal w-full sm:w-[500px] ${addModal && "modal_show"}`}>
        ...
        <form onSubmit={handleAddTAlliance} className="p-4">
          <div>
            <p>Image *</p>
            <ImageUploading
              value={images}
