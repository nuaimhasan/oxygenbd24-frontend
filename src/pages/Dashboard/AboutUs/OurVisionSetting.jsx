...
} from "../../../Redux/ourVision/ourVisionApi";
import Spinner from "../../../components/Spinner/Spinner";

const OurVisionSetting = () => {
  ...
  const updateAboutUsHandler = async (e) => {
    ...
    if (id) {
      ...
      try {
        ...
        if (res?.success) {
          setImage([]);
          Swal.fire("", "Vision add success", "success");
        }
      } catch (error) {
        Swal.fire("", error?.data?.error, "error");
      }
  ...
  return (
    <section className="bg-base-100 rounded shadow">
      <div className="p-4 border-b">
        <h3 className="font-medium text-neutral">Our Vision</h3>
      </div>
...
export default OurVisionSetting;
